...
\begin{figure}
	...
	\resizebox{0.8\linewidth}{!}{	\begin{forest} 
...
\end{figure}\pagebreak
\noindent 
In \sectref{sec-carstens:3.3} I will suggest that Romance languages may be covert Type 1 languages, yielding the groupings in \tabref{ex-carstens:20}, where speculative members are parenthesized.
...
\end{forest}
\end{figure}
\noindent The possessor DP is merged next. At this point, Brinson argues that PAM's uNum can receive ``delayed valuation" \citep{Carstens2016}, that is, valuation deferred until an expression with appropriate features is merged higher in the same phase (see also \citealt{Bejar_Rezac2009}). This is shown in \figref{fig-carstens-11}. \pagebreak
