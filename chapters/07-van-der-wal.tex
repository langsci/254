...
\begin{figure}
\caption{Proposed derivation of \REF{ex-vdwal:15}\label{ex-vdwal:16}}
...
\begin{figure}
\caption{Left: v agrees with TH (and can object-mark it). Right: v agrees with BEN (and can object-mark it)\label{fig:vdw:5}\todo[inline]{please check caption}}
% % \label{ex-vdwal:33}
\begin{multicols}{2}\raggedcolumns
\forestset{nice empty nodes/.style={for tree={calign=fixed edge angles}, delay={where content={}{shape=coordinate, for current and siblings={anchor=north}}{}}
			},
