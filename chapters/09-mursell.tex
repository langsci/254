...
\ex Hinuq \citep[][633]{Forker2012} \label{ex:hinuq_cross-clausal}
	...
	\ex \label{ex:hinuq_non-loc}
		\gll \textbarɡlotstopali-\v{z} \textbf{b}-eti-yo [ [ obu-y ec'endiyu \textbf{ma\v{s}ina} b-ux-ʎ'os-ɬi ] Madina-z \textbf{b}-eq'-ayaz ].\\
...
\ex Uyghur \citep[][3]{Asarina_Hartman2011a} \label{ex:uyg_gen_ass}
	\xlist
	\ex 
		\gll *[ Ötkür-nɨŋ oqu-ʁan] Ajgül-nuŋ kitav-i uzum.\\
