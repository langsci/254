...
\ea\label{adverbial}\gll [naan vi\textrtailt\textrtailt-ukk\U{} poo-ji-\textrtailt\textrtailt\U-\nga],
call pa\N\D-r-een-\nga\\ 
...
\ea\label{hanging}\gll [naan va-nd\U-\nga], naa\L\AI kki
...
\ea
 % \ea[]{
 %   \label{2ndquirk2}\gll onga\L-\U kk\U{} coffee vee\N um-aa-\nga?\\
 %   you.\textsc{pl}-\textsc{obl}-\textsc{dat}{} coffee want-\textsc{q}-\textsc{alloc}\\
 %   \glt `Do you want coffee?'
 % }
 \ea{
   \label{2ndnoagr2}\gll nii\nga{} saap-\textrtailt-aa\v{c}\v{c}-aa-\nga?\\
   you.\textsc{pl}{} eat-\textsc{asp}-\textsc{res}-\textsc{q}-\textsc{alloc}\\
   \glt `Have you eaten?'
 }
 \ex{
   \label{direct2}\gll nii\nga{} saap-\textrtailt-aa\v{c}\v{c}\U-\nga\L-aa?\\
...
\ea\label{coffee}
  \ea{
    \label{coffeeQA}\gll onga\L-\U kk\U{} coffee vee\textrtailn um-aa-\nga?\\
    you.\textsc{pl}-\textsc{obl}-\textsc{dat}{} coffee want-\textsc{q}-\textsc{alloc}\\
    \glt `Do you want coffee?' (some bias, direction not clear)
  }
  \ex{
    \label{coffeeAQ}\gll onga\L-\U kk\U{} coffee vee\textrtailn um-\nga\L-aa?\\
    you.\textsc{pl}-\textsc{obl}-\textsc{dat}{} coffee want-\textsc{alloc}-\textsc{q}\\
    \glt `Do you want coffee?' (no bias)
  }
  \ex{
    \label{coffeeAQA}\gll onga\L-\U kk\U{} coffee vee\textrtailn um-\nga\L-aa-\nga?\\
...
decide which is more likely to be correct.% \footnote{There is of course
...
might look:\footnote{One should not take the label `AllAgr' too
  ...
  of upward Agree \citep[e.g.][]{zeijlstra:2012} though see also \citetv{chapters/11-diercks-etal}.}
...
representation of an addressee.\footnote{This of course raises
  ...
  until we have a better grasp on the empirical situation. Especially relevant here will be the comparison with other types of agreement which involve the C domain, in particular upward and downward complementizer agreement, as discussed by \citetv{chapters/11-diercks-etal}.} We do,
