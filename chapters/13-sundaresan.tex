...
\noindent   \tabref{per1} shows that there is not one, but three, non-1st and
  ...
  [$\pm$\Author] and [$\pm$\textsc{addressee}], thus automatically bear this
...
One of the main advantages of the \ph-deficiency approach is its
  ...
  the anaphor's \ph-features have been valued. \cite\\textsc{author}{roorwyn:2011}
...
\noindent As \citeAuthor{collinspostal:2012} show, a sentence like (\ref{impost1}) is only
...
\textsc{author}] and [$\pm$\textsc{addressee}] via morphological, rather than
featural, underspecification, where possible, to keep the
featural toolbox more parsimonious.}
 
  \begin{table}[p]\small
      \caption{\color{red}Please give me a caption.\label{tab:sundaresan:5}}
      \begin{tabular}{l@{ }lll}
      \lsptoprule
...
its antecedent featurally indistinguishable).
        ...
        \ea\label{avansp} {[}\textminus \Author, \textminus \textsc{addressee}, sentience, m, sg]
