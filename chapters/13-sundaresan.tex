...
\citep{adgerramchand:2005, Hicks:2009}.\footnote{See also \citetv{chapters/11-diercks-etal} for very interesting discussion of the featural make-up of anaphors and their agreement behavior.}
...
as a coherent class of grammatical element.
...
course of the derivation.\footnote{This is not a trivial
  ...
  violating the Inclusiveness Condition in \citet{chomsky:1995},
  381. Hicks assumes, therefore, that a pronoun or R-expression is
  born with a feature whose values is simply a \emph{pointer} or
...
``imposters''\footnote{\citet{collinspostal:2012}, 5, Ex.\ 10, define
...
in \citealp{patelgrosz:2014} and \citealp{murugrayn:2017}. Based on
...
\item[(i)] Perspectival anaphora which are defined by a deficiency of
 ...
 (e.g.\ Malayalam \citep{jayaseelan:1997}, Japanese
...
\noindent Under a simple \ph-deficiency view, both `the glasses' with
 ...
 While this initially looks like promising, we have nevertheless
 ...
 such anaphors are defined in terms of something than \ph-features{}
 ...
 A different sort of problem has to with the so-called ``subject
...
\noindent \citet{rosen:1990}, \citet{baker:2008} also report analogous data for
...
it.\footnote{For a non-local anaphor in subject position (e.g.\ Tamil
  \taan \phantom{t}\citep{sundaresan:2016a, sundaresan:2018}), this falls out
...
its antecedent featurally indistinguishable).
        ...
        (cf.\ (\ref{sub}) vs.\ (\ref{nosub})). Note, though, that
